...
abstract class Twig_Tests_Profiler_Dumper_AbstractTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        return $this->generateProfile('main', 1, true, 'template', 'index.html.twig', $subProfiles);
    }
    ...
    {
        return $this->generateProfile('foo', 0.0001, false, 'macro', 'index.html.twig', $subProfiles);
    }
